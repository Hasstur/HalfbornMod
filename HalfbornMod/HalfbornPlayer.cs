    ...
    public class HalfbornPlayer : ModPlayer
    {
        ...
        public static readonly PlayerLayer WeaponLayer = new PlayerLayer("HalfbornMod", "WeaponLayer", PlayerLayer.HeldItem, delegate (PlayerDrawInfo drawInfo)
        {
            ...
            {              
                     ...
                     {
                         Texture2D texture2 = mod.GetTexture("Glow/DemonBow_Glow");
                         Vector2 position2 = new Vector2((float)(int)((double)drawInfo.itemLocation.X - (double)Main.screenPosition.X), (float)(int)((double)drawInfo.itemLocation.Y - (double)Main.screenPosition.Y));
                         Vector2 origin2 = new Vector2(drawPlayer.direction == -1 ? (float)texture2.Width : 0.0f, (double)drawPlayer.gravDir == -1.0 ? 0.0f : (float)texture2.Height);
                         DrawData data4 = new DrawData(texture2, position2, new Rectangle?(), Color.White, drawPlayer.itemRotation, origin2, drawPlayer.HeldItem.scale, drawInfo.spriteEffects, 0);
                         Main.playerDrawData.Add(data4);
        ...
        {
            string className = " "; string powerName = " ";
            ...
            if (HalfbornMod.DevilTrigger.JustPressed && warDemon && currentPower == 1)
            {
            ...
            if (HalfbornMod.DevilTrigger.JustPressed && warDemon && currentPower == 2)
            {
            ...
            if (HalfbornMod.DevilTrigger.JustPressed && warDemon && currentPower == 3)
            {
                Projectile.NewProjectile(player.position.X + 20f, player.position.Y - 10f + (float)Main.rand.Next(-3, 3), 5f, 0f, 706, 70, 0f, player.whoAmI, 0f, 0f);
                Projectile.NewProjectile(player.position.X + 20f, player.position.Y + (float)Main.rand.Next(-3, 3), 5f, 0f, 706, 70, 0f, player.whoAmI, 0f, 0f);
                Projectile.NewProjectile(player.position.X + 20f, player.position.Y + 10f + (float)Main.rand.Next(-3, 3), 5f, 0f, 706, 70, 0f, player.whoAmI, 0f, 0f);
            }

            if (HalfbornMod.DevilTrigger.JustPressed && shootDemon && currentPower == 1)
            {
            ...
            if (HalfbornMod.DevilTrigger.JustPressed && shootDemon && currentPower == 2)
            {
            ...
            if (HalfbornMod.DevilTrigger.JustPressed && shootDemon && currentPower == 3) 
            {
            ...
            if (HalfbornMod.DevilTrigger.JustPressed && mageDemon && currentPower == 1)
            {
            ...
            if (HalfbornMod.DevilTrigger.JustPressed && mageDemon && currentPower == 2)
            {
            ...
            if (HalfbornMod.DevilTrigger.JustPressed && mageDemon && currentPower == 3)
            {
            ...
            if (HalfbornMod.DevilTrigger.JustPressed && summonDemon && currentPower == 1)
            {
            ...
            if (HalfbornMod.DevilTrigger.JustPressed && summonDemon && currentPower == 2)
            {
                for (int j = 0; j < 1000; j++)
                {
                    player.maxMinions++;
            ...
            if (HalfbornMod.DevilTrigger.JustPressed && summonDemon && currentPower == 3)
            {
                for (int j = 0; j < 5; j++)
                {
                    player.maxMinions++;
        ...
        public override void PostUpdateEquips()
        {
            ...
            if (player.statLife < player.statLifeMax2 / 2 && !demonForm && demonPower > 0 && !player.dead) demonForm = true;
